 ...
 <html>
      ...
      <ul>
        ...
        <li><a href="eni.php">ENIs</a></li>
           ...
           <br /><br />
           <h2 align="center">AWS FQDN List</a></h3>
           <div class="container">
           ...
           <h6 align="center">Last updated @ <?php  echo exec("ls -l --time-style='+%d-%m-%Y %H:%M %Z' fqdn.json| awk '{print $6,$7,$8}'");   ?> </a></h3>
      </body>
 </html>
 <script>
