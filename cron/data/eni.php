 ...
 <html>
      ...
      <ul>
        ...
        <li><a href="eni.php">ENIs</a></li>
           ...
           <br /><br />
           <h2 align="center">AWS Network Interface List</a></h3>
           <div class="container">
                <table id="data-table" class="table table-bordered">
                     <thead>
                          <tr>
                               ...
                               <th style="width: 75px">Private IPs</th>
                               <th>SGs</th>
                          </tr>
                     </thead>
                </table>
           ...
           <h6 align="center">Last updated @ <?php  echo exec("ls -l --time-style='+%d-%m-%Y %H:%M %Z' eni.json| awk '{print $6,$7,$8}'");   ?> </a></h3>
      </body>
 </html>
 <script>
