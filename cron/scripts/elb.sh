...
generate_list() {
        ...
        for region in ${region_list}; do
                ...
                data=`aws elb describe-load-balancers --query "LoadBalancerDescriptions[].[SourceSecurityGroup.OwnerAlias, DNSName, Instances[].InstanceId]" --output json  --region $region`
